...
const NoteControls: React.FC = () => {
    ...
    const pitches = context.score.stave.lines.map(l => l.pitch).reverse();
    ...
    return (
        <Group gap={4} ml={"lg"}>
            <ControlButton
                ...
                active={!!context.currentNote?.detune || !!context.score.stave.lines.find(l => l.pitch === context.currentNote?.pitch)?.detune}
